...
<body>
	...
	if (sourceServlet.equals("sendEmailPass")) {
		String check = request.getAttribute("success") + "";
		check = check.equals("null") ? "" : check;
		if (check.equals("false")) {
			String tinNhan = request.getAttribute("tinNhan") + "";
			tinNhan = tinNhan.equals("null") ? "" : tinNhan;
			msg = tinNhan;
			kiemTra = true;
		}
	}
	...
	<div class="content">
		...
		<form action="send-mail" method="post">
			...
			<h1 class="title">Nhập email đã đăng kí</h1>
				...
				<button type="btn-email" class="submit-email">OK</button>
			</form>
		</div>
	</div>
	<!-- /.login-form -->
