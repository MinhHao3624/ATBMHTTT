...
<title>No product favorite</title>
<!-- Bootstrap -->
...
<body>
	...
	<c:if test="${baoLoi.length() != 0 }">
		<div style="text-align: center; margin: 50px 0;">
			<img src="images/no-favorites.png" alt="No Favorites"
				style="width: 150px; height: 150px;">
			<h3 style="color: #555;">Bạn chưa có sản phẩm nào trong danh
				sách yêu thích</h3>
