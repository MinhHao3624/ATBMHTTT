			...
			<div class="box">
				<div class="row-account">
					<div class="left-container">
						...
						<div class="side-bar-content">
							<ul>
								...
								<a
									href="${pageContext.request.contextPath}/profile-reset-password?userID=${sessionScope.khachHang.userID}">
					...
					<div class="right-container">
						<h3 class="title-content">Phản hồi/ Chi tiết phản hồi</h3>
						<div class="receipt-infor-details">
							<div class="title-receipt">
								<div class="left-content content">
									<h4>Phản hồi</h4>
									<p class="receipt-id">Mã phản hồi: ${feedback.feedID}</p>
									<p class="receipt-time">Ngày phản hồi: ${feedback.createAt}</p>
								</div>
								<p></p>
								<div class="right-content content">
									...
									<p class="address">Câu hỏi: ${feedback.titleMessage}</p>
								</div>
							</div>
							<table class="table">
								<thead class="thead-light">
									...
									<textarea class="form-control" id="textarea" name="textarea" rows="4"
                                                placeholder="Chi tiết">${feedback.messageUser}</textarea>
								</thead>
								<tbody>
									<h3>Trả lời từ Admin</h3>
									<textarea class="form-control" id="textarea" name="textarea" rows="4"
                                                placeholder="Chi tiết">${feedback.messageAdmin}</textarea>
								</tbody>
							</table>
							<a href="go-to-phan-hoi?page=1"
								class="redirect-to-receipt text-blue"><i
								class="fas fa-long-arrow-alt-left"></i> Danh sách phản hồi</a>
						</div>
					</div>
					<!-- /.features -->
				</div>
