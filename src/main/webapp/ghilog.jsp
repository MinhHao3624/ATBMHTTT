    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="border mb-2">
          <h4 class="text-center mt-3 mb-4">Bảng thống kê Log của khách hàng</h4>
          <div class="row">
          ...
          <table class="table table-hover table-text-center">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" data-toggle="tooltip" data-placement="top" title="Số lượng sản phẩm được thêm"><span
                    title="Số lượng sản phẩm"> Khi nào</span></th>
                <th scope="col" data-toggle="tooltip" data-placement="top" title="Số lượng sản phẩm tồn kho"><span
                    title="Số lượng sản phẩm"> Ở đâu</span></th>
                <th scope="col">Resource</th>
                <th scope="col">userID</th>
                <th scope="col">Dữ liệu trước</th>
                <th scope="col">Dữ liệu sau</th>
              </tr>
            </thead>
            <tbody id="content-table">
              <tr>
                ...
                <td>Login</td>
                <td>1742675899375</td>
                <td><a href="#"><button>Xem ảnh</button></a></td>
                <td><a href="#"><button>Xem ảnh</button></a></td>
              </tr>
            </tbody>
          </table>
