	...
	<div class="modal" id="successModal">
		<div class="modal-content">
			<img
				...
				alt="Notify Icon" style="width: 100px; height: 50px" />
			<h3><%=baoLoi%></h3>
			<button class="btn-close" onclick="closeModal()" name = "action" value="xacThuc"><a href="${pageContext.request.contextPath}/huy-Phien">Đóng</a></button>
			<button class="btn-close" ><a href="${pageContext.request.contextPath}/re-Dang-Nhap">Đăng nhập lại</a></button>
		</div>
	</div>
	<%} %>
	<script>
