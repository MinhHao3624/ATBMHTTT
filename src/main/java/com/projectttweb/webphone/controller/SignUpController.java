    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (error.length() > 0) {
                ...
                //dam bao user vua tao dang nhap duoc
                user.setIsKey("Hoạt động");
                System.out.println("Đang chuẩn bị Insert user: " + user.getUserName());
                int ketQuaInsert = userDao.insert2(user);
                System.out.println("Kết quả Insert database: " + ketQuaInsert);
                ...
                if (ketQuaInsert > 0) {
                    ...
                    System.out.println("Lỗi: insert2 trả về 0, dữ liệu không được lưu!");
                }
